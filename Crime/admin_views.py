...
class NewStation(LoginRequiredMixin,TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        staff = PoliceReg.objects.filter(login__last_name='0',login__is_staff='0',login__is_active='1')
        context['staff'] =  staff
        return context
...
class Officer_approve(LoginRequiredMixin,TemplateView):
    ...
    def get_context_data(self, **kwargs):
        ...
        officer = Officer_Reg.objects.filter(user__last_name='0',user__is_staff='0',user__is_active='1')
...
class Profile_details(TemplateView):
    ...
    def get_context_data(self,**kwargs):
        ...
        single_view = Officer_Reg.objects.filter(id=pid)
