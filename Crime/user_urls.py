...
from Crime.user_views import IndexView, ViewCriminals, AddFeedback, SelectStation,View_complaint, \
    Complaint_reg,add_evidence_view,missing_view,View_Evidence,Evidence,contactpolice,View_Police
...
urlpatterns = [
    ...
    path('View_Police',View_Police.as_view()),
    path('contactpolice',contactpolice.as_view()),
